# Archivo histórico del roadmap de Onyx Chess Lab

> Instantánea archivada el 2026-09-15 al sustituir el roadmap acumulativo por un documento
> operativo más breve. Este archivo conserva decisiones, estados y registros anteriores por
> trazabilidad, pero **no es la fuente vigente de prioridades ni de estado**.

# Chess Lab — Contexto, estado y roadmap (archivo legado)

> Documento legado; consulte `PROJECT_ROADMAP.md` para el estado vigente.
>
...
**Estado: Implementada y validada manualmente el 2026-09-09; validación del instalador NSIS 0.15.5 pendiente.**
...
- [ ] repetir el smoke test con el instalador NSIS 0.15.5 firmado antes de publicar la release;
